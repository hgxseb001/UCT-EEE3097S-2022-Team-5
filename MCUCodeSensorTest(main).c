...
int main(void)
{
  ...
  uint8_t dat = 0;
	...
	HAL_UART_Transmit(&huart2, "\rstart\r\n", sizeof("\rstart\r\n"), 1000);
...
//	  sprintf(buffer, "%.2f, %.2f, %.2f\r\n",my_gyro.x,my_gyro.y, my_gyro.z );
	  ...
	  //sprintf(buffer, "\r%d, %d, %d \r\n",Data1.gyrXH <<8 + Data1.gyrXL,Data1.gyrYH <<8 + Data1.gyrYL,Data1.gyrZH <<8 + Data1.gyrZL );
...
data->x = (int16_t)(read_single_icm20948_reg(ub_0, B0_GYRO_XOUT_H)<<8 | read_single_icm20948_reg(ub_0, B0_GYRO_XOUT_L));
data->y = (int16_t)(read_single_icm20948_reg(ub_0, B0_GYRO_YOUT_H)<<8 | read_single_icm20948_reg(ub_0, B0_GYRO_YOUT_L));
data->z = (int16_t)(read_single_icm20948_reg(ub_0, B0_GYRO_ZOUT_H)<<8 | read_single_icm20948_reg(ub_0, B0_GYRO_ZOUT_L));
...
//	data->z = (int16_t)(temp[4] << 8 | temp[5]) + accel_scale_factor;
	...
	data->x = (int16_t)(read_single_icm20948_reg(ub_0, B0_ACCEL_XOUT_H)<<8 | read_single_icm20948_reg(ub_0, B0_ACCEL_XOUT_L));
	data->y = (int16_t)(read_single_icm20948_reg(ub_0, B0_ACCEL_YOUT_H)<<8 | read_single_icm20948_reg(ub_0, B0_ACCEL_YOUT_L));
	data->z = (int16_t)(read_single_icm20948_reg(ub_0, B0_ACCEL_ZOUT_H)<<8 | read_single_icm20948_reg(ub_0, B0_ACCEL_ZOUT_L))+accel_scale_factor;
